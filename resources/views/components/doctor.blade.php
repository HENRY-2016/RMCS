...
<body class="app-body">
	...
	<div class="w3-panel w3-blue w3-round-xlarge page-heading-div">
		<p class="page-name">Doctors </p>
        <div class="w3-container total-badge " >
            <p>Total Doctors <span class="w3-badge w3-red">{{$total}}</span></p>
        </div>
    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <p class="modal-title text-center" >Adding A New Doctor</p>
                </div>

                <!-- Modal body -->
                <div class="modal-body">
                    <form  action="{{route('DoctorResource.store')}}" method="post">
                        
                        {{ csrf_field() }}
                        @include('templates.doctor-add')
    ...
    <div class="modal fade modal-lg" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            ...
            <!-- Modal Header -->
            <div class="modal-header">
                <p class="modal-title text-center" >Editing A Doctor</p>
            </div>

            <!-- Modal body -->
            <div class="edit-modal-body">
                <form  action="{{route('DoctorResource.update','null')}}" method="post">
                    {{method_field('patch')}}
                    {{ csrf_field() }}
                    @include('templates.doctor-edit')
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="deleteModalLabel">Deleting A Doctor</h5>
            </div>
            ...
            <div class="modal-footer">
                ...
                <form  action="{{route('DoctorResource.destroy','null')}}" method="post">
                    {{ csrf_field() }}
                    {{method_field('DELETE')}}
...
$('#showModal').on('show.bs.modal', function(event){
    ...
    $.get(RequestUrl, function (data) {
        ...
        $('#show-Details-id').html(data.data.Details);
    })
});
...
$('#editModal').on('show.bs.modal', function(event){
    ...
    $.get(RequestUrl, function (data) {
        ...
        $('#edit-Details').val(data.data.Details);
